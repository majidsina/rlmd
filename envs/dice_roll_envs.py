...
from tests.test_input_envs import dice_roll_env_tests, multi_env_tests
...
UP_R = 0.5                  # upside return (UP_R>MID_R)
DOWN_R = -0.5               # downside return (DOWN_R<0)
MID_R = 0.05                # mid return (MID_R>DOWN_R)
...
dice_roll_env_tests(UP_PROB, DOWN_PROB, UP_R, DOWN_R, MID_R)
...
class Dice_InvA(gym.Env):
    ...
    def step(
        ...
        r = np.random.choice(
            [UP_R, DOWN_R, MID_R], p=[UP_PROB, DOWN_PROB, MID_PROB], size=self.n_gambles
        )
